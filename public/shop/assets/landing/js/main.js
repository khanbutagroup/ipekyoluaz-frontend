...
(function ($) {
    ...
    //             self.$wrapper.find('.product-single-swiper').trigger('to.owl.carousel', index);
    //         });
    ...
    //         if ($product.find('.product-single-swiper').length) { // single carousel
    //             $images = $product.find('.product-single-swiper .owl-item:not(.cloned) img');
    ...
    //             var carousel = $product.find('.product-single-swiper, .product-gallery-carousel').data('owl.carousel'),
    //                 curIndex = carousel ?
    //                     // Carousel Type
...
(function ($) {
    ...
    Wolmart.init = function () {
        ...
        // Wolmart.shopShop.init();                                    // Initialize Shop
