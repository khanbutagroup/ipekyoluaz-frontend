...
export default function MainForVendorStore(props) {
  ...
  useEffect(() => {
    vendor(window.location.href.split("/")[4]).then((items) => {
  ...
  const handleChangeSubCategories = (e, id, title) => {
    ...
    productByUser(window.location.href.split("/")[4], data).then((e) => {
      let sizeData = [];
  ...
  const setPageFunc = (p, s) => {
    productById(p, s, window.location.href.split("/")[3]).then((items) => {
                    ...
                    <div className="address-info">
                      ...
                      <ul className="seller-info-list list-style-none">
                        <li className="store-address">
                         ...
                         {vendorDetail?.address_addtional}
                        </li>
                  ...
                  <div className="sidebar-content scrollable">
                    <div className="sticky-sidebar">
                      ...
                      <div
                        ...
                        style={{ display: url === "vendorStore" ? "none" : "" }}
                      >
